...
Обеспечить отправку разных типов PUSH-уведомлений в мобильное приложение:
- брошенная корзина,
- отмена заказа,
...
## Отдельно о рекламных PUSH

Рекламные push-уведомления отправляются только при наличии согласия пользователя и с учётом его настроек уведомлений.
